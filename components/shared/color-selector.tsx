  ...
  return (
    <div>
      <div className="flex flex-col gap-[10px]">
        ...
        <div className="grid grid-cols-[repeat(5,min-content)] gap-x-[5px] gap-y-[10px] min-[960px]:gap-x-[55px] min-[960px]:mt-[55px] min-[960px]:ml-[20px] justify-start w-full">          
          {casesApi.map((c) => {
          ...
          return (
            <button
              ...
              className="relative flex items-center justify-center outline-none group h-8 w-8 min-[960px]:scale-[1.6]"
            >
              {/* Anillo exterior: más fino (1.5px) y color más suave */}
              <div
                className={`w-7 h-7 rounded-full flex items-center justify-center transition-all duration-300 border-[1.5px] min-[960px]:scale-[1.8]
                    ${isSelected
