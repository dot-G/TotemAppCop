...
export function SmartphoneBackCase({
  ...
  // Printable area is the full case (excluding camera zone)
  const printArea = {
    x: framePadding,
    y: framePadding,
  ...
  // Image dimensions - fit to full case height
  const baseImageWidth = printArea.width * 1
  ...
  // Center the image in the print area (full case)
  ...
  // Center point for rotation (center of the full case)
    ...
    <div className={cn("relative inline-block", className)}>
      ...
      >
        <defs>
          ...
          {/* Clip for printable area - full case with camera cutout */}
          <clipPath id={`printAreaClip-${uniqueId}`}>
            <path
              fillRule="evenodd"
              d={`
                M ${printArea.x + printAreaRadius} ${printArea.y}
                H ${printArea.x + printArea.width - printAreaRadius}
                A ${printAreaRadius} ${printAreaRadius} 0 0 1 ${printArea.x + printArea.width} ${printArea.y + printAreaRadius}
                V ${printArea.y + printArea.height - printAreaRadius}
                A ${printAreaRadius} ${printAreaRadius} 0 0 1 ${printArea.x + printArea.width - printAreaRadius} ${printArea.y + printArea.height}
                H ${printArea.x + printAreaRadius}
                A ${printAreaRadius} ${printAreaRadius} 0 0 1 ${printArea.x} ${printArea.y + printArea.height - printAreaRadius}
                V ${printArea.y + printAreaRadius}
                A ${printAreaRadius} ${printAreaRadius} 0 0 1 ${printArea.x + printAreaRadius} ${printArea.y}
                Z
                M ${cameraZone.x + camera.rx} ${cameraZone.y}
                A ${camera.rx} ${camera.rx} 0 0 0 ${cameraZone.x} ${cameraZone.y + camera.rx}
                V ${cameraZone.y + cameraZone.height - camera.rx}
                A ${camera.rx} ${camera.rx} 0 0 0 ${cameraZone.x + camera.rx} ${cameraZone.y + cameraZone.height}
                H ${cameraZone.x + cameraZone.width - camera.rx}
                A ${camera.rx} ${camera.rx} 0 0 0 ${cameraZone.x + cameraZone.width} ${cameraZone.y + cameraZone.height - camera.rx}
                V ${cameraZone.y + camera.rx}
                A ${camera.rx} ${camera.rx} 0 0 0 ${cameraZone.x + cameraZone.width - camera.rx} ${cameraZone.y}
                Z
              `}
            />
          </clipPath>
        ...
        {/* Printable area background - full case with camera cutout */}
        <path
          fillRule="evenodd"
          d={`
            M ${printArea.x + printAreaRadius} ${printArea.y}
